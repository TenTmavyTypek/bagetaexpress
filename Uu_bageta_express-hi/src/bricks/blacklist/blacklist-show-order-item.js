...
const BlacklistShowOrderItem = createVisualComponent({
  //@@viewOn:statics
  uu5Tag: Config.TAG + "BlacklistShowOrderItem",
  ...
  render(props) {
    ...
    const currentNestingLevel = Utils.NestingLevel.getNestingLevel(props, BlacklistShowOrderItem);
...
//@@viewOn:exports
export { BlacklistShowOrderItem };
export default BlacklistShowOrderItem;
//@@viewOff:exports
