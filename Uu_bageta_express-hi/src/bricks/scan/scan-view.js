    ...
    return currentNestingLevel ? (
      <div {...attrs}>
        ...
        <Uu5Elements.Modal
          ...
          header={
            <Uu5Elements.Grid justifyContent="center">
              <Uu5Elements.Text>Pozor! Ak ukončíte výdaj bagiet všetky neprevzané objednávky budú uzamknuté!</Uu5Elements.Text>
            </Uu5Elements.Grid>
          }
        >
          <Uu5Elements.Grid justifyContent="center" templateColumns="1fr 1fr">
            ...
            <Uu5Elements.Button
              onClick={() => {setWarningOpen(false);setSuccessOpen(true);blockUsersCall.call()}}
              colorScheme="red"
              significance="highlighted"
            >
        ...
        >
          <Uu5Elements.Text colorScheme="building" {...title} type="micro">Výdaj bagiet bol úspešne ukončený.</Uu5Elements.Text>
        </Uu5Elements.Modal>
