...
describe(`Uu_bageta_express.Bricks.Blacklist.BlacklistProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<Uu_bageta_express.Bricks.Blacklist.BlacklistProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
