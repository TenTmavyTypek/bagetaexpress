...
describe(`Uu_bageta_express.Bricks.Management.ManagementProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<Uu_bageta_express.Bricks.Management.ManagementProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
