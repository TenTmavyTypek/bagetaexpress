...
describe(`Uu_bageta_express.Bricks.Summary.SummaryProvider`, () => {
  // it("onLoad", async () => {
  //   let onLoad = jest.fn(async () => ({ content: "Hello, world!" }));
  //   let loadDtoIn = { foo: "bar" };
  //   let wrapper = mount(<Uu_bageta_express.Bricks.Summary.SummaryProvider onLoad={onLoad} loadDtoIn={loadDtoIn} />);
