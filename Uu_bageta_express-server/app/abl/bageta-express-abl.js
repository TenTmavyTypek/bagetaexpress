...
const Errors = require("../api/errors/bageta-express-error.js");
...
const logger = LoggerFactory.get("BagetaExpressAbl");

class BagetaExpressAbl {
  constructor() {
